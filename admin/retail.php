        ...
        <script>
            ...
            <h1 class="my-4">Add Orders</h1>
                ...
                <hr style="height: 3px; border: none; color: #000; background-color: #000; width: 100%;">
                    <form method="POST" enctype="multipart/form-data" action="create_order_retail.php">
...
<script>
    // Disable the form and set input values to empty
    function disableForm() {
        // Get all the input elements by their names
        var nameInput = document.getElementsByName('wsname')[0];
    ...
    // Call the disableForm function when the page is loaded
