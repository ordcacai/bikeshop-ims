...
<?php
    ...
    $stmt1 = $conn->prepare("SELECT COUNT(*) As total_records FROM stock_transfer WHERE transfer_type = 'Outbound'");
    $stmt1->execute();
    ...
    //4. get all products
    $stmt2 = $conn->prepare("SELECT * FROM stock_transfer WHERE transfer_type = 'Outbound' ORDER BY transfer_id DESC LIMIT $offset, $total_records_per_page");
    $stmt2->execute();
...
<div class="main-content">
    <div class="container-fluid">
            ...
            <a class="btn btn-primary btn mb-5 me-4" style="float:right;" href="print_outbound.php"><i class="fas fa-print"></i> Print</a>
            <a class="btn btn-success btn mb-5 me-4" style="float:right;" href="stocks_outbound.php"><i class="fas fa-plus-circle"></i> Outbound</a>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover table-sm text-center">
                        ...
                        <?php while($row = $stocks->fetch_assoc()) { ?>
                            <tr>
                                <td><?php echo $row['transfer_id']; ?></a></td>
