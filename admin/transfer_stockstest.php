...
if (isset($_POST['record-transfer'])) {
    ...
    $stmt = $conn->prepare('INSERT INTO stock_transfer (location_from, location_to) VALUES (?, ?)');
    $stmt->bind_param('ss', $locationFrom, $locationTo);
    $stmt->execute();
    $stmt->close();
    ...
    <div class="container-fluid">
        ...
        <div class="table-responsive">
            ...
            <div class="mx-auto container">
                <form method="post" action="transfer_stockstest.php">
                    ...
                    <div class="container">
                        <div id="dynamicForm">
                            ...
                            <select class="form-select" required name="product_name" required>
