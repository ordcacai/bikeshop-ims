...
<?php
    ...
    $stmt1 = $conn->prepare("SELECT COUNT(*) As total_records FROM stock_transfer WHERE transfer_type = 'Inbound'");
    $stmt1->execute();
    ...
    //4. get all products
    $stmt2 = $conn->prepare("SELECT * FROM stock_transfer WHERE transfer_type = 'Inbound' ORDER BY transfer_id DESC LIMIT $offset, $total_records_per_page");
    $stmt2->execute();
...
<div class="main-content">
    <div class="container-fluid">
            ...
            <a class="btn btn-primary btn mb-5 me-4" style="float:right;" href="print_inbound.php"><i class="fas fa-print"></i> Print</a>
